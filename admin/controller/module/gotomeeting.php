<?php
class ControllerModuleGotoMeeting extends Controller {
    private $moduleName = 'GotoMeeting';
    private $moduleNameSmall = 'gotomeeting';
    private $moduleData_module = 'gotomeeting_module';
    private $moduleModel = 'model_module_gotomeeting';
    ...
    public function index() { 
        ...
        $languageVariables = array(
            ...
            'text_button_preview',
            'text_button_preview_help',
            'text_url',
            'text_url_help',
            'large_gray_button',
            'small_white_button',
            'gray_button_with_meeting_id',
            'white_button_with_meeting_id',
            'show_add_to_cart',
        ...
        if ($this->config->get('featured_status')) {
            $data['gotomeeting_status'] = $this->config->get('gotomeeting_status');
        } else {
            $data['gotomeeting_status'] = '0';
        }
        
        $data['gotomeeting_modules'] = array();
        if (isset($data['moduleSettings']['gotomeeting_module'])) {
            foreach ($data['moduleSettings']['gotomeeting_module'] as $key => $module) {
                $data['gotomeeting_modules'][] = array(
                    'key'    => $key,
                    'limit'  => $module['limit'],
                    'width'  => $module['width'],
