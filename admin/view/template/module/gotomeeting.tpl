...
<div id="content">
 <div class="page-header">
    <div class="container-fluid">
      <h1><i class="fa fa-microphone"></i>&nbsp;<?php echo $heading_title; ?></h1>
      <ul class="breadcrumb">
        ...
        <div class="panel panel-default">
                    ...
                    <div class="form-group">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <?php foreach ($stores  as $st) { ?>
                                <li><a href="index.php?route=module/gotomeeting&store_id=<?php echo $st['store_id'];?>&token=<?php echo $token; ?>"><?php echo $st['name']; ?></a></li>
                            <?php } ?> 
                        </ul>
                    </div>
                </div>
            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form"> 
                    ...
                    <input type="hidden" name="gotomeeting_status" value="1" />
                    <div class="tabbable">
                        <div class="tab-navigation form-inline">
                            <ul class="nav nav-tabs mainMenuTabs" id="mainTabs">
                                <li><a href="#control_panel" data-toggle="tab" class="active"><i class="fa fa-power-off"></i>&nbsp;Control Panel</a></li>
						...
						?>
                            <div id="control_panel" class="tab-pane fade"><?php require_once modification_vqmod(DIR_APPLICATION.'view/template/module/gotomeeting/tab_controlpanel.php'); ?></div>
                            <div id="main_settings" class="tab-pane fade"><?php require_once modification_vqmod(DIR_APPLICATION.'view/template/module/gotomeeting/tab_settings.php'); ?></div>
                            </div> <!-- /.tab-content -->
                    </div><!-- /.tabbable -->
                </form>
             </div>
