			...
			<div class="panel-body">
				...
				<div class="megamenu">
					<div class="tree-megamenu col-ms-4">
						...
						<input class="btn btn-success btn-sm" type="button" name="serialize" id="serialize" value="Обновить" />
						<?php echo $tree; ?>
						<input class="btn btn-success btn-sm" type="button" name="serialize" id="serialize_2" value="Обновить" />
