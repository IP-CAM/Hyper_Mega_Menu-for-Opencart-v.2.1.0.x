...
<div class="form-horizontal">
	<div class="row">
		...
		<div class="col-sm-8">
			<div class="pull-left">
				<a class="btn btn-success" title="" onclick="$('#formcom').submit();" data-toggle="tooltip" data-original-title="Сохранить"><i class="fa fa-save"> Сохранить </i></a>
				<?php if(!empty($module_comid)) { ?>
				<a onclick="confirm('Вы уверены?') ? location.href='<?php echo $delete_com; ?>' : false;" data-toggle="tooltip" title="" class="btn btn-danger" data-original-title="Удалить"><i class="fa fa-trash-o"> Удалить </i></a>
				<?php } ?>
			</div>
