...
<div class="form-horizontal">
	<div class="row">
		...
		<div class="col-sm-8">
			<div class="pull-left">
				<a class="btn btn-success" title="" onclick="$('#formlat').submit();" data-toggle="tooltip" data-original-title="Сохранить"><i class="fa fa-save"> Сохранить </i></a>
				<?php if(!empty($module_latid)) { ?>
				<a onclick="confirm('ВЫ уверены?') ? location.href='<?php echo $delete_lat; ?>' : false;" data-toggle="tooltip" title="" class="btn btn-danger" data-original-title="Удалить"><i class="fa fa-trash-o"> Удалить </i></a>
				<?php } ?>
			</div>
				...
				<div class="tab-pane active" id="tab-module-pavblogcomment">
					...
					<table class="table no-border">
							...
							<tr>
								...
								<td class="col-sm-10"><input class="form-control" type="text" name="pavbloglatest_module[prefixclass]" value="Префикс класса"></td>
							<tr>
							<!-- //Tab Product -->
							<tr>
