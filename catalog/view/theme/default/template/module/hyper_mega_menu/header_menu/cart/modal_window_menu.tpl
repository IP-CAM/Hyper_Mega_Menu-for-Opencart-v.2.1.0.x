    ...
    <div class="md-modal md-effect-<?php echo isset($cart_value['open_cart_popup']) ? substr($cart_value['open_cart_popup'], 6) : '1' ?> cart-modal-ajax-load"
         id="<?php echo isset($cart_value['open_cart_popup']) ? $cart_value['open_cart_popup'] : 'modal-1' ?>">
    <?php } ?>
        <?php if(!isset($menu_value['part_popup_cart']) || $menu_value['part_popup_cart'] == 'part1'){?>
    ...
    <?php } ?>
    <?php if(!isset($cartAjaxSuccess)){?>
        <li class="nav nav-cart-modal-ajax-load">
    <?php } ?>
            <?php if(!isset($menu_value['part_popup_cart']) || $menu_value['part_popup_cart'] == 'part2'){?>
            <a href="#" class="md-trigger" data-modal="<?php echo isset($cart_value['open_cart_popup']) ? $cart_value['open_cart_popup'] : 'modal-1' ?>" >
